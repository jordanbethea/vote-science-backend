...
//              to = Seq(data.email),
//              bodyText = Option("body"), //Some(views.txt.emails.alreadySignedUp(user, url).body),
//              bodyHtml = Some(views.html.user.emails.alreadySignedUp(user, url).body)
//            ))
//
...
////                from = Messages("email.from"),
////                to = Seq(data.email),
////                bodyText = Option("body"), //Some(views.txt.emails.signUp(user, url).body),
////                bodyHtml = Some(views.html.user.emails.signUp(user, url).body)
////              ))
//
