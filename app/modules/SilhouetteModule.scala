...
import controllers.UserControllers.{ DefaultRememberMeConfig, DefaultSilhouetteControllerComponents, RememberMeConfig, SilhouetteControllerComponents }
import models.db.UsersAndAuthentication._
...
class SilhouetteModule extends AbstractModule with ScalaModule {
  ...
  override def configure(): Unit = {
    ...
    //bind[SilhouetteControllerComponents].toInstance(DefaultSilhouetteControllerComponents())
